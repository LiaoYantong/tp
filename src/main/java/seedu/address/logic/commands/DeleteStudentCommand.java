...
public class DeleteStudentCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_STUDENT_SUCCESS = "Student [%1$s - %2$s] has been successfully removed from the system.";
    public static final String MESSAGE_STUDENT_NOT_FOUND = "Deletion unsuccessful. No student found with matric number: %1$s";
    public static final String MESSAGE_HAS_ACTIVE_LOANS = "Deletion blocked. Student has active loans that must be returned first.";
